...
title('work set size: app1 = 0.5 * cache, app2 = 0.75 * cache');
h = legend('overall improvement','app1 improvemetn', 'app2 improvement', 'Location', 'SouthEast');
set(h,'Fontsize',12);

figure, plot(s1_prob, hitrate1_app2, 'r--+');
grid on;
set(gca,'YMinorGrid','on');
hold on; 
plot(s1_prob, hitrate2_app2, 'g--*');
xlabel ('changing the scheduling');
ylabel ('app2 hit rate');
